...
import { useTransactions } from '@/hooks/use-transactions'; // Import new hook
...
export function AdminDashboard() {
  ...
  const { transactions: allTransactions, isLoading } = useTransactions(); // Use hook
              ...
              <TableBody>
                {filteredTransactions.slice(0, 5).map(t => (
                  <TableRow key={t.id}>
                    ...
                    <TableCell>{t.attendantName}</TableCell>
